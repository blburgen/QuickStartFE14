export default function Navigation() {
    ...
    <div className="container-fluid navbar-expand-md ">
        <nav className="navbar navbar-nav d-flex justify-content-evenly" data-bs-theme="dark">
            <a className="text-center bg-primary nav-link col-md-2 col-12 border border-dark rounded-3 active" href=".\">Home Page Week 14</a>
            ...
            <ul className="navbar-nav col-md-3 col-12">
                <li className="nav-item dropdown col-md text-center bg-primary border border-dark rounded-3">
                    ...
                    <ul className="dropdown-menu col-12">
                        ...
                        <li><a className="nav-link bg-primary border border-dark rounded-3 text-center active" href="https://blburgen.github.io/QuickStartFE14/">Quick Start Front End Week 14-16</a></li>
                        <li><a className="nav-link bg-primary border border-dark rounded-3 text-center" href="https://blburgen.github.io/QuickStartFE16/">Quick Start Front End Week 16-18</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
